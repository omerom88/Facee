...
SAMPLES_DIR = 'C:\Users\OMER\Desktop\ML\facee\Face-Recognition-Training-for-Sky-Biometry-API-master\samples'  # the directory path to the samples
FACE_API_KEY = '15b6875b12b94f538cff772d587a1135'
FACE_API_SECRET = 'a065ca49f4ab418f99fecd99d212999d'
FACE_NAMESPACE = 'facee'
...
def main():
    ...
    response_omer = client.faces_detect(file='C:\Users\OMER\Desktop\ML\omer_finda.jpg')
                                             # ''C:\Users\OMER\Desktop\ML\omer_set1.jpg'
                                             # 'C:\Users\OMER\Desktop\ML\omer_set.jpg,C:\Users\OMER\Desktop\ML\omer_set2.jpg')
    response_etomer = client.faces_detect(file='C:\Users\OMER\Desktop\ML\etomer_find.jpg')
                                               # ',C:\Users\OMER\Desktop\ML\etomer_set1.jpg,'
                                               # 'C:\Users\OMER\Desktop\ML\etomer_set2.jpg')

    tids_omer = [photo['tags'][0]['tid'] for photo in response_omer['photos']]
    tids_etomer = [photo['tags'][0]['tid'] for photo in response_etomer['photos']]
    tags_save_omer = client.tags_save(tids = ',' . join(tids_omer), uid = 'omer@facee', label = 'omer')
    tags_save_etomer = client.tags_save(tids = ',' . join(tids_etomer), uid = 'tomer@facee', label = 'tomer')
    face_train_omer = client.faces_train('omer@facee')
    face_train_etomer = client.faces_train('tomer@facee')
    rec = client.faces_recognize('all',file='C:\Users\OMER\Desktop\ML\omer_find.jpg',namespace='facee')
    print(rec['photos'][0]['tags'][0]['uids'])
