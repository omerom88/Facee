...
def main():
    ...
    res = client.faces_recognize('all@facee',None,'C:\Users\OMER\Desktop\ML\Benjamin Sisko 02.jpg',None,None,None,None)
    # get_T = client.tags_get()
    print(res)
    print(res['photos'][0]['tags'][0]['uids'])
